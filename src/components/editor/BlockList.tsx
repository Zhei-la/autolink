      ...
      {showAddSheet && (
        ...
        >
          <div
            ...
            className="bg-white w-full max-w-md sm:rounded-2xl rounded-t-2xl mx-auto my-auto max-h-[80vh] overflow-y-auto"
          >
            <div className="border-b border-border p-4">
              <h2 className="font-bold text-lg">?됰뗀以??곕떽?</h2>
            </div>
            <div className="grid grid-cols-2 gap-2 p-4">
              {BLOCK_TYPES.map((b) => (
                <button
                  ...
                  className="h-24 sm:h-28 border border-border rounded-xl hover:border-primary hover:bg-primary-soft flex flex-col items-center justify-center gap-1.5 transition"
                >
